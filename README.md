...
body{font-family: 'Quicksand', sans-serif;padding: 25px}
#geser{opacity:.8;color:#ffffff;margin-top:12px;}
...
.scrollImage p{font-size:16px;font-weight:700;}
...
.scrollImage > *{display:flex;flex-wrap:nowrap;text-align:center;align-items:center;justify-content:center;border-radius:10px;flex-shrink:0; width:90%; height:30vh;background:#FFFFFF;margin:0 15px 0 0; scroll-snap-align:center} .scrollImage > *:last-child{margin-right:0} .scrollImage:after{content:'';display:block;flex-shrink:0; align-self:stretch;padding-left:20px}

/* Teks Ganjil */.scrollImage p:nth-child(odd){color:#0B1600;}
/* Teks Genap */.scrollImage p:nth-child(even){color:#000D8A;}
#wrn1{color:#C600C3} #wrn2{color:#3D7A00}

blockquote{position:relative;opacity:.8;margin-left:0;margin-right:0; padding:30px 25px;}
blockquote{color:#fefefe;font-size:15px;padding:30px 25px 30px 45px; border:1px solid #97999A;border-left:0;border-right:0} blockquote:before{content:'\201D';display:block; position:absolute;top:18px;left:0; font-weight:700;font-size:60px; line-height:normal}
...
.foto, .content2{display:block;text-align:center;width:100%;height:150px;margin-top:50px;}
.foto > *, .content2 > *{display:flex;align-items:center;justify-content:center;margin-top:15px;font-size:18px;color:white}
.foto img{border-radius:50%;transition:all .1s ease;}
                    ...
                    if(sayang){
                        ...
                        if(persen){
                            ...
                            if(kangen){
                                ...
                                await swals.fire('Thx uu!', 'Udah meluangkan waktunya!');
